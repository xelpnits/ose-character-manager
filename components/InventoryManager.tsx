...
import { Container, Item, Character, ItemCategory } from '../types';
    ...
    <div className="space-y-6">
       ...
       <div className="flex flex-col sm:flex-row justify-between items-end pb-4 border-b border-white/5">
          ...
          <button 
            ...
            className="mt-4 sm:mt-0 text-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-600 hover:border-indigo-500 px-4 py-2 rounded-lg flex items-center transition-all shadow-lg"
          >
            <Plus className="w-4 h-4 mr-2" /> New Container
          </button>
       </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        {containers.map((container) => {
            ...
            // Calc fill percentage for visual bar
                ...
                <div className="px-4 py-3 border-b border-white/5 flex items-center justify-between gap-3 bg-white/5 rounded-t-xl relative z-10">
                  ...
                  {!container.isFixed && (
                    <button
                        ...
                        onMouseDown={(e) => {
                            // Critical: Stop parent drag handlers
                            e.stopPropagation();
                        }}
                ...
                <div className="p-4">
                    {container.items.length === 0 ? (
                        ...
                        >
                            ...
                            {/* Hover indicator that this is interactable */}
